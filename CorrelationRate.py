import os
import findspark
os.environ["SPARK_HOME"] = "/Users/hongbowang/spark-2.2.0-bin-hadoop2.7"
findspark.init()
...
def recomm(text, data_path, pip_path, lda_path, recomm_num = 5):
    ...
    print(data_withDis.select("topicDistribution").take(1))

    data_sort = data_withDis.sort("dis")

    print(data_sort.select("topicDistribution").take(1))
